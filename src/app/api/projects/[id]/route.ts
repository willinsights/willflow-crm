...
export async function PUT(
  ...
  console.log('🟢 [API] PUT /api/projects/[id] - Request recebido');
  ...
  try {
    ...
    // Atualizar no banco
    console.log('💾 Atualizando projeto no banco:', { id, updates });
    ...
    console.log('✅ Projeto atualizado no banco com sucesso!');
    ...
    console.error('❌ [API] Erro ao atualizar projeto:', {
