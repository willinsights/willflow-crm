...
import { filterProjectsByPermission, sanitizeProjectForUser, getUserPermissions } from '@/lib/permissions';
...
export default function RoleTestPanel() {
  ...
  const simulateUserView = (user: User) => {
    ...
    const filteredProjects = filterProjectsByPermission(mockProjects, user);
      ...
      <CardHeader className="pb-3">
        ...
        <div className="flex items-center gap-4 mt-3">
          ...
          <div className="text-sm text-muted-foreground">
            ...
            Finance: {(simulatedView?.permissions.canViewAllFinancials ?? displayUser.canViewFinance) ? '✅' : '❌'} |
      ...
      {isExpanded && (
        <CardContent className="space-y-4">
          ...
          <div className="glass rounded-lg p-3">
            ...
            {(simulatedView?.permissions.canViewAllFinancials ?? currentUser?.canViewFinance) ? (
